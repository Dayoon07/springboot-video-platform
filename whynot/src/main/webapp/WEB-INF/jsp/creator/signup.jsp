...
<body>
	<jsp:include page="${ cl }/WEB-INF/common/header.jsp" />
	    ...
	    <div class="mt-12 mx-auto bg-gray-200 p-8 rounded-lg shadow-lg max-w-2xl text-black">
	            ...
	            <div class="flex justify-between">
	            	<div class="w-96 mx-2">
			            ...
			            <div class="mb-4">
			                ...
			                <input type="password" id="confirmPassword" name="confirmPassword" class="w-full p-2 rounded bg-white text-black focus:outline-none focus:ring-2 focus:ring-black" required>
			            </div>
			            <div class="mb-4">
			                <label for="tel" class="block text-sm mb-2">전화번호</label>
			                <input type="tel" id="tel" name="tel" class="w-full p-2 rounded bg-white text-black focus:outline-none focus:ring-2 focus:ring-black" required>
			            </div>
	            	</div>
		            <div class="w-96 mx-2">
		            	<div class="mb-4">
		            	...
		            	<div class="mb-4">
			                ...
			                <textarea id="bio" name="bio" class="w-full p-2 rounded bg-white text-black focus:outline-none 
			                	focus:ring-2 focus:ring-black resize-none" rows="7"></textarea>
			            </div>
		            </div>
	            </div>
