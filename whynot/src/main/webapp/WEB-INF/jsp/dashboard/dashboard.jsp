...
<body class="flex flex-col h-screen">
    ...
    <main class="flex flex-grow" style="height: calc(100% - 76px);">
        <div class="w-64 bg-gray-200">
            <ul>
                <li>
                    <a href="${ cl }/myVideo/dashboard" class="block p-4 rounded bg-gray-200 bg-white hover:bg-white transition">대시보드</a>
                </li>
                <li>
			    ...
			    <div class="bg-white p-4 rounded-lg shadow-lg mb-6">
			        ...
			        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
			            <div class="text-center p-4 border border-gray-200 rounded-lg">
			                ...
			                <p class="text-3xl font-bold">${ countMyVideos }</p>
			            </div>
			            <div class="text-center p-4 border border-gray-200 rounded-lg">
			                <h4 class="text-lg font-semibold">총 조회수</h4>
			                <p class="text-3xl font-bold">${ sumMyVideosViews }</p>
			            </div>
			            <div class="text-center p-4 border border-gray-200 rounded-lg">
			                <h4 class="text-lg font-semibold">총 좋아요</h4>
			                <p class="text-3xl font-bold">${ sumMyVideosLikes }</p>
			            </div>
			            <div class="text-center p-4 border border-gray-200 rounded-lg">
			                <h4 class="text-lg font-semibold">총 댓글 수</h4>
			                <p class="text-3xl font-bold">${ sumMyVideosComment }</p>
			            </div>
			        </div>
			    </div>
