	    	...
	    	<div class="hidden md:flex hover:bg-gray-200 cursor-pointer transition">
	    		<div class="relative py-4">
	    			<a href="${ cl }/watch?v=${ mlv.videos.videoUrl }">
	    				<img src="${ mlv.videos.imgPath }" alt="poster 쓰고 싶다" width="300" class="px-4 rounded-md cursor-pointer">
	    			</a>
	    	...
	    	<div class="md:hidden video-item flex flex-col gap-2 p-2 rounded-lg hover:bg-gray-200">
			    <div class="relative">
			        <div class="aspect-video bg-gray-200 rounded-lg overflow-hidden">
			            <a href="${ cl }/watch?v=${ mlv.videos.videoUrl }">
			                <img src="${ mlv.videos.imgPath }" class="w-full h-full object-cover" loading="lazy">
			            </a>
			        </div>
			    ...
			    <div class="flex gap-2">
			        <a href="${ cl }/channel/${ mlv.videos.creator }">
			            <img src="${ mlv.videos.frontProfileImg }" class="w-10 h-10 rounded-full bg-gray-200 flex-shrink-0">
			        </a>
